                ...
                <div id="almaty-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
                    <div class="relative bg-white rounded-lg shadow w-11/12 max-w-xl p-6">
                        <button type="button" aria-label="Close"
                                class="absolute top-3 right-3 text-gray-400 hover:text-gray-900" onclick="document.getElementById('almaty-modal').classList.add('hidden')">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                        </button>
                        <h3 class="text-lg font-semibold mb-3">Внимание</h3>
                        <p class="text-gray-700 leading-relaxed">{!! str_replace('https://ordaexpress.kz', '<a href="https://ordaexpress.kz" class="text-blue-600 underline">https://ordaexpress.kz</a>', e(session('almaty_notice'))) !!}</p>
                        <div class="mt-6 text-right">
                            <button type="button" class="px-4 py-2 bg-gray-700 text-white rounded hover:bg-gray-800" onclick="document.getElementById('almaty-modal').classList.add('hidden')">Понятно</button>
                        </div>
                    </div>
                </div>
            @endif
                        ...
                        <div id="defaultTabContent" class="p-4">
                            ...
                            <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                                ...
                                <li class="flex items-center">
                                    ...
                                    <p><small>@if($track->city != '') Отправлено в город - {{ $track->city }} @elseif($track->status == 'Отправлено в Ваш город' && $track->city == '') Отправлено в Ваш город @else Получено клиентом @endif</small><br />
